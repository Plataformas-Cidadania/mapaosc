...
import gov.sgpr.fgv.osc.portalosc.configuration.shared.model.DefaultUser;
import gov.sgpr.fgv.osc.portalosc.configuration.shared.model.FacebookUser;
...
public class LogonWidget extends Composite {
	...
	public LogonWidget(ConfigurationModel user) {
		initWidget(getLoggedHtml(user.getNome()));
	}
